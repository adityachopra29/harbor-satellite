...
// It checks the --config flag first, then falls back to the default location.
...
To get started, run:
  ...
  gcctl satellite list`,
	...
	root.AddGroup(&cobra.Group{ID: "management", Title: "Management:"})
	...
	// Future: satellite, group, config commands will be added here
